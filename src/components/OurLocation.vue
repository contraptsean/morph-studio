<template>
  <div class="location section bg-light" id="our-location">
   <div class="container px-4 py-5">

    <h2 class="pb-2 border-bottom mt-5 display-4" data-aos="fade-down" data-aos-duration="500" data-aos-once="true">Our Location</h2>

     <div class="row row-cols-1 row-cols-lg-2">
    <div class="col mt-5" data-aos="fade-left" data-aos-duration="500" data-aos-once="true">
    ...
    <div class="col mt-5" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">
       ...
       <p class="lead">Morph Textures Salon is an appointment based, boutique salon located at 1617 South Adams St, Unit 2, top floor. There is parking available in the front of the building with steps on the right to our cozy porch. </p>
